...
const offerings = [
  ...
  'Front-end customization enabled',
  'Lifetime Licence',
]

const steps = [
  { num: 1, title: 'Process Analysis', text: 'Efficiently manage your payroll with our state-of-the-art processing services. From accurate salary disbursements.' },
  { num: 2, title: 'Data Gathering', text: 'Navigate the complexities of financial management with our professional accounting and bookkeeping services.' },
  { num: 3, title: 'Policy Configuration', text: 'Ensure a seamless tax season with our expert tax preparation and filing services. We handle all necessary documentation.' },
  { num: 4, title: 'Go Live', text: 'Empower your business with strategic financial guidance. Our experienced advisors provide insights and recommendations.', last: true },
]

const modules = ['E-Recruitment', 'Core HRMS', 'Time Office', 'Leave / Absence', 'Payroll', 'IT & TDS', 'Tax']

export function WebBasedPage() {
  return (
    <>
      <section className="stp-30 bg-softBg1 relative max-xxl:overflow-hidden">
        ...
        <div className="container grid grid-cols-12 gap-6 max-md:stp-15 relative z-10">
          <div className="col-span-12 md:col-span-6 flex justify-center items-start flex-col">
            ...
            <h1 className="display-3 pt-4">Web Based HRMS</h1>
            <p className="text-bodyText pt-6">
              Welcome to Ritmax, nline payroll &amp; HRMS software is a easy &amp; proven software that enables our clients to
              manage their entire HR and Payroll activities at a single click within a minutes that directly saves the time
              &amp; increase accuracy as well as transperancy of process.
            </p>
          </div>
      ...
      <section className="stp-30 sbp-30">
        <div className="container grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-6">
            <h1 className="display-4">We help you with Web Based services</h1>
            <p className="text-bodyText pt-4 pb-6 lg:pb-8">
              At Ritmax, we understand the critical importance of accurate and timely payroll processing. Our comprehensive
              payroll solutions
            </p>
      ...
      <section className="bg-softBg1 stp-30 sbp-30">
        <div className="container">
          <div className="max-w-[700px] mx-auto text-center flex justify-center items-center flex-col">
            ...
            <h1 className="display-4 pt-4 pb-4 lg:pb-6">4 simple steps to Go Live!!</h1>
        ...
        <div className="container">
          <div className="max-w-[700px] mx-auto text-center">
            <div className="p-12 sm:p-12">
              <h4 className="heading-4 mb-4 md:mb-6 pb-2 relative after:absolute after:w-[20%] after:h-[2px] after:bottom-0">
                Modules
              </h4>
