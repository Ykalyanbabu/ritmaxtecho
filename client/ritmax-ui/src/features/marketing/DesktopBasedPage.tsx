...
const features = [
  { icon: 'ph-fill ph-hand-coins', title: 'Competitive Price', text: 'Efficient payroll processing tailored to the unique needs of healthcare professionals. Ensure accurate and timely compensation' },
  { icon: 'ph-fill ph-gear', title: 'Highest Features', text: 'Stay compliant with ever-evolving healthcare regulations. Our services include compliance management to ensure your practice' },
  { icon: 'ph-fill ph-users-three', title: 'Multi-user in LAN', text: 'Receive personalized consulting services to address the unique challenges of your healthcare practice.' },
...
const entryFeatures = [
  ...
  'Quick Salary Entry',
  'Overtime Entry',
  'Present Entry(Muster Entry)',
  'Leave Entry From',
  'User & User Right Entry / Holiday List',
]

export function DesktopBasedPage() {
  return (
    <>
      <section className="stp-30 bg-softBg1 relative max-xxl:overflow-hidden">
        ...
        <div className="container grid grid-cols-12 gap-6 max-md:stp-15 relative z-10">
          <div className="col-span-12 md:col-span-6 flex justify-center items-start flex-col">
            ...
            <h1 className="display-3 pt-4">Desktop Based</h1>
            <p className="text-bodyText pt-6">
              Ritmax&apos;s Healthcare Services are designed to support the financial health of your medical practice or
              healthcare facility
            </p>
          </div>
      ...
      <section className="stp-30 sbp-30">
        <div className="container">
          <div className="max-w-[900px] mx-auto text-center flex justify-center items-center flex-col">
            <p className="bg-p1 py-2 sm:py-3 px-5 rounded-full text-white">Desktop Based</p>
            <h1 className="display-4 pt-4 pb-4 lg:pb-6">Most Demanded Payroll Software Ever!!</h1>
        ...
        <div className="container grid grid-cols-12 gap-6 max-xxl:overflow-hidden">
          <div className="col-span-12 md:col-span-6">
            <div className="max-w-[600px] flex justify-start items-start flex-col">
              <p className="bg-p1 py-3 px-5 rounded-full text-white">Entry Module</p>
              <h1 className="display-4 pt-4 pb-6">Features of Our Payroll Software</h1>
